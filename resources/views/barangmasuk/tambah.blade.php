              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-inline">
                    <label class="sr-only" for="inlineFormInputName2">No Masuk</label>
                        <input type="text" name="nomasuk" class="form-control mb-2 mr-sm-2" id="nomasuk" placeholder="Nama Barang" required="required">
                 ...
                 <label class="sr-only" for="inlineFormInputName2">Nama Barang</label>
                        ...
                        <select type="text" name="id_supplier" class="form-control mb-2 mr-sm-2" id="id_supplier" placeholder="Nama Jenis Barang" required="required">
                 ...
                 <label class="sr-only" for="inlineFormInputName2">Tanggal Masuk</label>
