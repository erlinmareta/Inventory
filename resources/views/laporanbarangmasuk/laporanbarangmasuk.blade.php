              ...
              <div class="card">
                <div class="card-body">
                    <div class="section-title">
                      <h2>INVOICE BUKTI PEMASUKAN BARANG</h2>
                    </div>
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                      @foreach($laporanbarangmasuk as $b)
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $b->nomasuk }} </td>
                          <td>{{ $b->nama }} </td>
                ...
                <div class="modal-body">
                  ...
                  <label>Tanggal Mulai</label>
                        <input type="date" name="date" class="form-control mb-2 mr-sm-2" id="date" placeholder="tgl_mulai" value="<?=date('Y-m-d')?>" required="required">
                 ...
                 <div class="input-group-prepend">                   
                  ...
                  <label>Tanggal Selesai</label>
                        <input type="date" name="date" class="form-control mb-2 mr-sm-2" id="date" placeholder="tgl_selesai" value="<?=date('Y-m-d')?>" required="required">
                    <div class="input-group mb-2 mr-sm-2">
                 <div class="input-group-prepend">                   
                    </div>
                 </div>
            ...
            <div class="modal-dialog modal-lg">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                    ...
                    <br><a class="btn btn-primary mb-2" href="/laporanbarangmasuk/cetakbarangmasuk" title="Cetak"><span class="fa fa-print"></span> Cetak</a></br>
                </div>
              </div>
            </div>
</div></div>
