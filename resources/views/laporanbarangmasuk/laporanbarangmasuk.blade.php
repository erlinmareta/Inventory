...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="row">
            ...
            <form method="GET" action="{{ url('laporanbarangmasuk/cetakbarangmasuk') }}">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="dateStart" class="form-control mb-2 mr-sm-2"
                                            id="date" placeholder="tgl_mulai" value="<?= date('Y-m-d') ?>"
                                            required="required">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dateEnd" class="form-control mb-2 mr-sm-2"
                                                id="date" placeholder="tgl_selesai" value="<?= date('Y-m-d') ?>"
                                                required="required">
                                            <div class="input-group mb-2 mr-sm-2">
                                                <div class="input-group-prepend">
                                                </div>
